...
"""Generated IPC contract + sidecar version registry (data only).

The source of truth is crates/ados-protocol/contracts.toml. The hand-written
...
CONTRACT_CATALOG: dict[str, dict[str, object]] = {
    "plugin.rpc": {
        "version": 1,
        "wire": "msgpack",
...
SIDECAR_CATALOG: dict[str, dict[str, object]] = {
    "cloud-link": {
        "version": 1,
        "wire": "json",
        "transport": "/run/ados/cloud-link.json",
        "status": "sidecar",
