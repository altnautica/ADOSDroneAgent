...
def build_heartbeat_payload(app: AgentApp) -> dict:  # noqa: C901
    ...
    # The MAVLink WebSocket is authenticated on the raw ``mavlinkWs`` proxy
    # itself via a ticket subprotocol the native router validates — there is
    # no separate gated endpoint to advertise.
