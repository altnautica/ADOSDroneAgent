...
async def build_setup_status(  # noqa: C901
    ...
    # The MAVLink WebSocket is authenticated on the raw proxy (``websocket_url``,
    # the :8765 listener) via a ticket subprotocol the native router validates,
    # for any profile — there is no separate gated endpoint to advertise.
