...
native routes (tested in the Rust front). The scan stays in the residual and
delegates to the singleton ``WifiClientManager``, so the test patches the
singleton factory and asserts the route returns what the manager produced.
"""
